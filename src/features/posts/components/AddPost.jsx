    ...
    <>
      <div className="dark:bg-[#252728] bg-white p-8 rounded-xl shadow-lg w-full max-w-lg flex justify-center items-center gap-4">
        ...
        <button
          ...
          className="h-[80%] dark:bg-[#333334] dark:text-gray-300 text-black/80 bg-gray-100 hover:text-black font-medium w-full rounded-full px-4 py-4 text-start dark:hover:bg-gray-600 hover:bg-gray-200 cursor-pointer flex items-center"
        >
          {t("startTypingPost")}
        </button>
      </div>
